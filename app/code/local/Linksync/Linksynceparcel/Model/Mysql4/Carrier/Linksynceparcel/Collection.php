<?php
class Linksync_Linksynceparcel_Model_Mysql4_Carrier_Linksynceparcel_Collection extends Varien_Data_Collection_Db
{
    ...
    {
        parent::__construct(Mage::getSingleton('core/resource')->getConnection('eparcel_read'));
        $this->_shipTable = Mage::getSingleton('core/resource')->getTableName('linksync_linksynceparcel_tabelrate');
        ...
        $this->_select->from(array("s" => $this->_shipTable))
            ...
            ->order(array("dest_country", "dest_region_id", "dest_zip"));
